...
//			startActivity(intent);
	...
	mangitudDetalle.setText(String.format("%.2f",magnitudeQuake));
	 if (magnitudeQuake>=5)   mangitudDetalle.setBackgroundResource(R.drawable.rounded_edittext_red);
	    else if (magnitudeQuake>3)  mangitudDetalle.setBackgroundResource(R.drawable.rounded_edittext_green);
	    else if (magnitudeQuake>2)   mangitudDetalle.setBackgroundResource(R.drawable.ounded_edittext_yellow);
	    else  mangitudDetalle.setBackgroundResource(R.drawable.rounded_edittext);
