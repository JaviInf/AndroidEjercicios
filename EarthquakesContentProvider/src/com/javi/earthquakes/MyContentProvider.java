...
public class MyContentProvider extends ContentProvider {
	public static final Uri CONTENT_URI = Uri.parse("content://com.javi.earthquakes.skeletondatabaseprovider/elements");
	...
	static {
	   ...
	   uriMatcher.addURI("com.javi.earthquakes.skeletondatabaseprovider","elements", ALLROWS);
	   uriMatcher.addURI("com.javi.earthquakes.skeletondatabaseprovider","elements/#", SINGLE_ROW);
	}
	...
	public Uri insert(Uri uri, ContentValues values) {
		  SQLiteDatabase db = myOpenHelper.getWritableDatabase();
	        ...
	        long rowID = db.insert(EarthquakesDBOpenHelper.DATABASE_TABLE,
	                "quake", values);
	...
	public boolean onCreate() {
		myOpenHelper = new EarthquakesDBOpenHelper(getContext(), EarthquakesDBOpenHelper.DATABASE_NAME, null, EarthquakesDBOpenHelper.DATABASE_VERSION,null);
		return true;
	}
